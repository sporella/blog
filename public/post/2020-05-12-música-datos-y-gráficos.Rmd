...
Me propuese como desafío utilizar sólo librerías de tidyverse, para no crear bucles. También cambié algunas cosas sobre los datos del disco que estaban erradas en Spotify.
...
Como se observa, el disco tiene pocos momentos de felicidad (todas las pistas están bajo el 0.5), es un disco melancólico, así que los fans están en su derecho a emocionarse y llorar en pantalla. Un dato curioso, es que en el primer disco, las tres canciones con más valencia fueron las que se tomar como singles del album, justo en ese orden.
